...
namespace Fanxs.cn.QQLight.Old
{
    public class OLD
    {
        /// 给QQ名片点赞
        ...
        public static extern string Api_SetErrorCode(string Code, string Str, int AuthCode);
        ...
        public static extern void Api_AddGroup(string GroupID, string info, int AuthCode);
        /// <summary>
        /// 主动添加好友
        /// </summary>
        /// <param name="QQID"></param>
        ...
        public static extern int Api_GetPraiseNum(string QQID, int AuthCode);
        /// <summary>
        /// 取得某个QQ的等级
        /// </summary>
        /// <param name="QQID"></param>
        ...
        public static extern int Api_Taotaodolike(string QQID, string URL, int AuthCode);
        ...
        public static extern int Api_Taotaofeeds(string QQID, string URL, string Content, int AuthCode);
        ...
        public static extern void Api_DeleteMsg(string Type, string GroupID, string QQID, string MsgID, int AuthCode);
        ...
        public static extern void QL_SetQQState(int Type, int AuthCode);
        ...
        public static extern void QL_InviteFriendToGroup(string GroupID, string QQID, int AuthCode);
        ...
        public static extern void Api_UpLoadPic(int Type, string Obj, string Bin, int AuthCode);
        /// <summary>
        /// 设置插件状态，开启或关闭
        /// </summary>
        ...
        public static extern void Api_SetPluginState(bool State, int AuthCode);
        ...
        public static extern void Api_DeleteFile(string GroupNUm, string FileGuid, int AuthCode);

        [DllImport("message.dll", EntryPoint = "Api_RepeatFile", CallingConvention = CallingConvention.Winapi)]
        public static extern void Api_RepeatFile(string GroupID, string GroupNum, string FileGuid, int AuthCode);
